...
# Next-GrokApp public README is intentionally free of author promo, social QR,
# contributor galleries, and screenshot showcases. Do NOT re-run
# scripts/update-contributors.py here (that script is upstream-oriented and
# would re-inject gallery blocks).
