...
Assets are attached below. Install help (macOS `xattr` / Gatekeeper, Windows SmartScreen, Linux packages, CLI): [README](https://github.com/Next-AGI-Org/Next-GrokApp#install--first-run) · [README 中文](https://github.com/Next-AGI-Org/Next-GrokApp/blob/main/README.md#%E5%AE%89%E8%A3%85%E4%B8%8E%E4%BD%BF%E7%94%A8) · Full history: [CHANGELOG.md](https://github.com/Next-AGI-Org/Next-GrokApp/blob/main/CHANGELOG.md)
"""
